...
4. 重启路由，再次进入uboot，输入http://192.168.1.1/uboot.html，刷入新的适配itb的uboot文件：mt7981-cmcc_rax3000m-emmc-fip-fit.bin
5. 进入新的uboot，刷入先刷immortalwrt-24.10.x-mediatek-filogic-cmcc_rax3000m-initramfs-recovery.itb文件
